...
public class DataInitializer implements CommandLineRunner {
    ...
    private void initDishes() {
        ...
        createDish("Грибной крем-суп",
                ...
                400, 320.00, "Супы", "грибнойКремСуп.jpg", 3);
        ...
        createDish("Том Ям с креветками",
                ...
                450, 450.00, "Супы", "томЯмСКреветками.jpg", 3);
        ...
        createDish("Суп Рамен",
                ...
                600, 390.00, "Супы", "супРамен.jpg", 3);

        // ─── Основные блюда → Курс 4 (Основное блюдо) ──────────────────
        createDish("Овощи гриль с розмарином",
                ...
                300, 220.00, "Основные блюда", "овощиГриль.jpg", 4);
        ...
        createDish("Стейк Рибай Black Angus",
                ...
                350, 1890.00, "Основные блюда", "стейкРибайBlackAngus.jpg", 4);
        ...
        createDish("Картофельные драники",
                ...
                220, 190.00, "Основные блюда", "картофельныеДраники.jpg", 4);

        // ─── Морепродукты → Курс 4 (Основное блюдо) ────────────────────
        createDish("Паста с тигровыми креветками",
                ...
                400, 590.00, "Морепродукты", "пастаСТигровымиКреветками.jpg", 4);
        ...
        createDish("Равиоли с крабом",
                ...
                280, 1340.00, "Морепродукты", "равиолиСКрабомИШампанским.jpg", 4);
        ...
        createDish("Лосось под фисташками",
                ...
                300, 790.00, "Морепродукты", "лососьПодФисташковойКорочкой.jpg", 4);
        ...
        createDish("Кальмары в хрустящем кляре",
                ...
                350, 420.00, "Морепродукты", "кальмарыВХрустящемКляре.jpg", 4);

        // Устрицы — исключение: морепродукт, но подаётся как холодная закуска
        createDish("Устрицы Рокфеллер",
                ...
                180, 990.00, "Морепродукты", "устрицыРокфеллер.jpg", 2); // ← курс 2 (закуска)

        // ─── Салаты → Курс 2 (Закуска / Холодные блюда) ────────────────
        createDish("Цезарь с тигровыми креветками",
                ...
                300, 620.00, "Салаты", "цезарьСТигровымиКреветками.jpg", 2);
        ...
        createDish("Греческий с кедровыми орехами",
                ...
                250, 370.00, "Салаты", "греческийСКедровымиОрехами.jpg", 2);
        ...
        createDish("Салат «Вальдорф»",
                ...
                280, 390.00, "Салаты", "салатВальдорф.jpg", 2);
        ...
        createDish("Салат «Мимоза»",
                ...
                200, 290.00, "Салаты", "салатМимоза.jpg", 2);
        ...
        createDish("Круассан с миндальным кремом",
                ...
                120, 180.00, "Десерты", "круассанСМиндальнымКремом.jpg", 5);
        ...
        createDish("Пирог с ревенём и меренгой",
                ...
                180, 210.00, "Десерты", "пирогСРевенемИМеренгой.jpg", 5);
        ...
        createDish("Панна-котта с карамелью",
                ...
                200, 390.00, "Десерты", "паннаКоттаВКарамельномКорже.jpg", 5);
        ...
        createDish("Эклеры с заварным кремом",
                ...
                100, 150.00, "Десерты", "эклерыСЗаварнымКремом.jpg", 5);
        ...
        createDish("Парфе из белого шоколада",
                ...
                180, 430.00, "Десерты", "парфеИзБелогоШоколада.jpg", 5);

        // ─── Напитки → Курс 1 (Аперитив / подаются сразу) ──────────────
        ...
        createDish("Глинтвейн безалкогольный",
                ...
                500, 350.00, "Напитки", "глинтвейнБезалкогольный.jpg", 1);
        ...
        createDish("Чай \"Цитрусовый рай\"",
                ...
                500, 240.00, "Напитки", "чайЦитрусовыйРай.jpg", 1);
        ...
        createDish("Чай «Царский сбор»",
                ...
                500, 250.00, "Напитки", "чайЦарскийСбор.jpg", 1);
        ...
        createDish("Матча-латте",
                ...
                500, 490.00, "Напитки", "матчаЛатте.jpg", 1);
        ...
        createDish("Латте с карамелью",
                ...
                300, 380.00, "Напитки", "латтеСКарамелью.jpg", 1);
        ...
        createDish("Эспрессо Мароккано",
                ...
                200, 220.00, "Напитки", "эспрессоМароккано.jpg", 1);
        ...
        createDish("Гляссе с лавандой",
                ...
                350, 410.00, "Напитки", "гляссеСЛавандой.jpg", 1);

        System.out.println("Меню успешно заполнено.");
    }

    /**
     * Проставляет defaultCourse всем блюдам, у которых он ещё не задан
     * (значение по умолчанию = 1, присвоенное Java-полем).
     *
     * Вызывается после initDishes() и обновляет курс по категории блюда.
     * Это безопасная миграция: блюда с уже изменённым курсом (≠ 1) не трогаются,
     * чтобы не перезаписать ручные настройки администратора.
     *
     * ВАЖНО: если в системе уже есть блюда с правильно выставленными курсами,
     * этот метод ничего не испортит — он обновляет только блюда с courseNumber=1,
     * так как именно это значение выставляется по умолчанию новой колонкой.
     */
    private void initDefaultCourses() {
        // Маппинг «название категории» → «номер курса по умолчанию»
        Map<String, Integer> categoryToCourse = Map.of(
                "Напитки",        1,
                "Салаты",         2,
                "Супы",           3,
                "Морепродукты",   4,
        ...
        for (Dish dish : allDishes) {
            ...
            Integer course = categoryToCourse.get(categoryName);

            if (course != null && dish.getDefaultCourse() == 1) {
                // Блюдо ещё имеет дефолтное значение — можно безопасно обновить
                dish.setDefaultCourse(course);
        ...
        if (updatedCount > 0) {
            System.out.println("Курсы блюд обновлены по категориям: " + updatedCount + " блюд.");
        }
    }
    ...
    private void createDish(String name, String desc, String comp,
        ...
        dish.setDefaultCourse(defaultCourse);
